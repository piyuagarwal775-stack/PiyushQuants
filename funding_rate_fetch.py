                ...
                for f in s['filters']:
                    if f['filterType'] == 'LOT_SIZE':
                        ...
                        if '.' in step_str:
                            ...
                            precision = 0
                        return {'min_qty': min_qty, 'precision': precision}
        return {'min_qty': 0.001, 'precision': 3}
    except:
        return {'min_qty': 0.001, 'precision': 3}
            ...
            if not position_exists():
                ...
                if current_balance < MINIMUM_BALANCE:
                    ...
                    if nearest:
                        ...
                        if time_left > 2760:
                            wait_time = time_left - 2760
                            wait_minutes = wait_time / 60

                            now = datetime.now().timestamp()
                            rescan_time = now + wait_time
                            entry_time = rescan_time + 60
